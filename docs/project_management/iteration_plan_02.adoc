= Iteration Plan 02: Workflowergänzung OPAL-Druckauftrag
...
| Beginn der Iteration | 07.12.2020
| Verteilung der Aufgaben | 08.12.2020
| Besprechung der Zwischenergebnisse | 14.12.2020
| Ende der Iteration | 21.12.2020
|===
...
* Verstehen der Vorstellungen der Themensteller
* Verteilung der einzelnen Aufgaben
* Erstellen der Vision, des Glossars und der Use Cases um sie den Themenstellern zur Vefügung zu stellen
* Verbessern der Arbeit mit Github
...
* Themensteller segnet Visionsdokument ab
* Use Cases erfüllen die in Vorlesung und Praktikum besprochenen Anforderungen
* Glossar ist vorerst vollständig
